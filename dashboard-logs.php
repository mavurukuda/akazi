					...
					<div class="dashboard-list-box-content">
						...
						<table class="manage-table responsive-table">
							...
							<tr>
								...
								<th><i class="fa fa-check-square-o"></i> Username</th>
							...
							<!-- Item #2 -->
							<?php
								$sql = $conn->prepare("select * from userlog")or die(mysql_error());
								$sql->execute();
								while ($row = $sql->fetch()) {
							
								echo "<tr><td>".$row['userId']."</td><td>".$row['username']."</td>
								<td>".$row['datetimes']."</td><td>".$row['roles']."</td><td>".$row['statuss']."</td>
							";
