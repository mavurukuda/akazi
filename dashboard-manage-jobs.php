			...
			<ul id="responsive">
				...
				<li><a href="#" id="current">Dashboard</a>
					<ul>
						...
						<li><a href="dashboard-messages.php">Messages</a>
...
<div id="dashboard">
	...
	<div class="dashboard-content">
		...
		<div id="titlebar">
			<div class="row">
				<div class="col-md-12">
					<h2>Viewed Listed skills</h2>
					<!-- Breadcrumbs -->
					<nav id="breadcrumbs">
						<ul>
							<li><a href="#">Home</a></li>
							<li><a href="#">Dashboard</a></li>
							<li>Viewed Listed skills</li>
						</ul>
					</nav>
				</div>
			</div>
					...
					<div class="dashboard-list-box-content">
						...
						<table class="manage-table responsive-table">
							...
							<tr>
								...
								<th><i class="fa fa-calendar"></i> Availability</th>
								<th><i class="fa fa-calendar"></i> Rate/ Hr</th>
								<th><i class="fa fa-user"></i> Date Posted</th>
								<th>Action</th>
							</tr>
							...
							<?php
								...
								echo "<tr><td>".$row['OCCUPATIONTITLE']."</td><td>".$row['JOBDESCRIPTION']."</td>
								<td>".$row['STARTDATE']." to ".$row['ENDDATE']."</td><td>".$row['rateHr']."</td><td>".$row['DATEPOSTED']."</td>
								<td>
								<form class='form-sample' method='POST' action='dashboard-edit-job.php'>
									<input type='hidden'  class='form-control' name='JOBID' id='JOBID' value=' ".$row['JOBID']."'  />
									<button type='submit' class='button margin-top-15' name='savechanges' id='savechanges'>Edit</button>
								</form>
								<form class='form-sample' method='POST' action='delete-operations.php'>
									<input type='hidden'  class='form-control' name='JOBID' id='JOBID' value=' ".$row['JOBID']."'  />
									<button style='background-color:darkred' type='submit' class=' margin-top-15' name='deleteSkill' id='savechanges'>Delete</button>
								</form>
									</td>";
